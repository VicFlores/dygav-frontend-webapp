export default function statusReservationTemplate(
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                          <td class="logo" style="text-align: center;">
                            <h1 style="font-size: 20px;"><a href="#">Bienvenido a DYGAV</a></h1>
                          </td>
                      </tr>
                  </table>
              </td>
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td style="padding: 0 2.5em; text-align: center; padding-bottom: 1em;">
                            <div class="text">
                                <h2 style="font-size: 18px;"><strong>¡Hola!</strong> 👋</h2>
                            </div>
                        </td>
                    </tr>
                    <tr>
                          <td style="text-align: center;">
                              ...
                              <div class="text-author" style="font-size: 16px;">
                                ...
                                Queriamos informarte que el estado de la reserva en <strong>${accommodationName}</strong>, 
                                ha cambiado de <strong>${foundstatus}</strong> a <strong>${reservationStatus}</strong>.
</div>
                          </td>
                        </tr>
                </table>
