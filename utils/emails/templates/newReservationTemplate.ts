import { OccupiedPeriod } from '@/types';
                    ...
                    <tr>
                          <td style="text-align: center;">
                              ...
                              <div class="text-author" style="font-size: 16px;">
                                ...
                                Hemos recibido una nueva reserva para tu alojamiento <strong>${accommodationName}</strong> en las siguientes fechas:
                                <br>
                                <br>
                                <strong>Desde:</strong> ${
                                  occupiedPeriod !== null
                                    ? occupiedPeriod.startDate
                                    : 'Desconocido'
                                }
                                <br>
                                <strong>Hasta:</strong> ${
                                  occupiedPeriod !== null
                                    ? occupiedPeriod.endDate
                                    : 'Desconocido'
                                }
                                <br>
                                <br>
